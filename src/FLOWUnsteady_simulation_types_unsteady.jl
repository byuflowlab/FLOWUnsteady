...
function solve(self::Simulation{V, M, R}, Vinf::Function,
                ...
                init_sol::Bool=false, sigmafactor_vpmonvlm=1, sigmafactor_vlmonrotor=1, sigmafactor_rotoronvlm=1,
                debug=false
    ...
    if self.nt==0
        ...
        Vrotor_on_wing = Vvpm_on_Xs(staticpfield, vcat(Xs_cp_vlm, Xs_ApA_AB_BBp_vlm);
                                    static_particles_fun=static_particles_fun2, dt=dt, fsgm=sigmafactor_rotoronvlm,
                                    mirror, mirror_X, mirror_normal)
        ...
        Vvlmrotor_on_rotor = Vvpm_on_Xs(staticpfield, Xs_rotors;
                              static_particles_fun=static_particles_fun3, dt=dt, fsgm=sigmafactor_vlmonrotor,
                              mirror, mirror_X, mirror_normal)
