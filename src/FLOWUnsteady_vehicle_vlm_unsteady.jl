...
UVLMVehicle(system::vlm.WingSystem;
        ...
        rotor_systems::NTuple{M, Array{vlm.Rotor{TF_design, TF_trajectory}, 1}}=NTuple{0, Array{vlm.Rotor, 1}}(),
        grids=Array{gt.GridTypes, 1}(),
        optargs...
        ) where {N, M, R, TF_design, TF_trajectory} = UVLMVehicle{N, M, R}( system;
                                V=V, W=W,
...
UVLMVehicle(system::vlm.WingSystem, R;
        ...
        grids=Array{gt.GridTypes, 1}(),
        optargs...
        ) where {N, M, TF_design, TF_trajectory} = UVLMVehicle{N, M, R}( system;
                                V=V, W=W,
                                tilting_systems=tilting_systems,
                                rotor_systems=rotor_systems,
                                grids=Array{gt.GridTypes, 1}(grids),
