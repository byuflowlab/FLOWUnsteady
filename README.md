...
documentation: [`resources/validation.ipynb`](https://nbviewer.jupyter.org/github/byuflowlab/FlightVehicleSim/blob/master/resources/validation.ipynb).

For example simulations, check this notebook: [`resources/examples.ipynb`](https://nbviewer.jupyter.org/github/byuflowlab/FlightVehicleSim/blob/master/resources/examples.ipynb).

# Folders and Files
  * `src/`: Source code.
  * `examples/`: Example simulations.
  * `resources/`: Documentation (open Jupyter notebooks with [nbviewer](https://nbviewer.jupyter.org/)).
    - `resources/instructions-setup.md`: Instructions for setting up this package.
    - [`resources/validation.ipynb`](https://nbviewer.jupyter.org/github/byuflowlab/FlightVehicleSim/blob/master/resources/validation.ipynb): Validation of models implemented in this package and numeric observations.
    - [`resources/examples.ipynb`](https://nbviewer.jupyter.org/github/byuflowlab/FlightVehicleSim/blob/master/resources/examples.ipynb): Results of example simulations.
...
for Maneuvering Multirotor Aircraft</i>. AIAA SciTech Forum. <a href="https://github.com/byuflowlab/FLOWUnsteady/blob/master/resources/AlvarezNing_2021-SciTechAbstract-FLOWUnsteady_solver.pdf"><b>[PDF]</b></a><br><br>
  * Alvarez, E. J., (2020). <i>Quasi-steady Aerodynamics Solver for a High-fidelity Controls Framework</i>. FLOWUnsteady Documentation. <a href="https://github.com/byuflowlab/FLOWUnsteady/blob/master/resources/quasisteadysolver.pdf"><b>[PDF]</b></a><br><br>
